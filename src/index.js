...
// const list1 =document.querySelector('article')
// list1.addEventListener('click', (e) => {
//   const input = content.querySelector('text-area-class');
